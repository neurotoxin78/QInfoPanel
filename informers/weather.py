...
class Weather(QFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.we_condition_description.setMinimumSize(QSize(250, 32))
        self.wind_speed.setMinimumSize(QSize(165, 32))
        self.setupUI()

    def setupUI(self):
        self.we_condition.setIconSize(QSize(72, 72))
        self.we_condition.clicked.connect(self.refresh)
        self.layout.addWidget(self.we_condition, 0, 6, 6, 6, Qt.AlignmentFlag.AlignCenter)
        self.layout.addWidget(self.wind_speed, 1, 0, 1, 4, Qt.AlignmentFlag.AlignLeft)
        self.layout.addWidget(self.wind_dir, 1, 4, 1, 3, Qt.AlignmentFlag.AlignLeft)
        self.layout.addWidget(self.we_condition_description, 0, 1, 1, 5, Qt.AlignmentFlag.AlignCenter)
        ...
        self.we_condition_description.setFont(QFont('DejaVu Sans Mono for Powerline', 18))
        self.we_condition_description.setAlignment(Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignHCenter)
        self.current_temperature.setFont(QFont('DejaVu Sans Mono for Powerline', 18))
        self.current_humidity.setFont(QFont('DejaVu Sans Mono for Powerline', 18))
        self.current_pressure.setFont(QFont('DejaVu Sans Mono for Powerline', 18))
        self.wind_speed.setFont(QFont('DejaVu Sans Mono for Powerline', 18))
        self.wind_speed.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        self.wind_speed.setMinimumSize(QSize(200, 40))
        self.wind_dir.setFont(QFont('DejaVu Sans Mono for Powerline', 18))
        self.wind_dir.setAlignment(Qt.AlignmentFlag.AlignLeft)
        self.current_temperature.setAlignment(Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignLeft)
        self.current_humidity.setAlignment(Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignLeft)
        self.current_pressure.setAlignment(Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignLeft)
    ...
    def colorizer(self):
        self.current_temperature.setStyleSheet("color: " + self.config['weather']['we_temperature_color'] + ";")
        self.current_humidity.setStyleSheet("color: " + self.config['weather']['we_humidity_color'] + ";")
        self.current_pressure.setStyleSheet("color: " + self.config['weather']['we_pressure_color'] + ";")
        self.we_condition_description.setStyleSheet("color: " + self.config['weather']['we_condition_color'] + ";")
        self.wind_speed.setStyleSheet("color: " + self.config['weather']['we_wind_speed_color'] + ";")
        self.wind_dir.setStyleSheet("color: " + self.config['weather']['we_wind_dir_color'] + ";")
    ...
    def get_weather(self):
        ...
        if x["cod"] != "404":
            ...
            self.we_condition_description.setText(u"| \ueb1a " + city_name + ": " + weather_description + " |")
            ...
            self.wind_speed.setText(u'вітер: <b>' + str(wind_speed) + '<sup>м/c</sup></b>  ')
            self.wind_dir.setText(u"  <b>" + str(wind_dir) + '</b>  ')
        else:
